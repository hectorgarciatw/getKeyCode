...
function Footer() {
    return (
        <footer className="bg-white dark:bg-gray-900 py-8 w-full bottom-0 left-0">
            <div className="container px-6 py-8 mx-auto">
                ...
                <div className="flex flex-col items-center sm:flex-row sm:justify-between">
                    ...
                    <div className="flex mt-3 -mx-2 sm:mt-0">
                        <a href="#" target="_blank" className="mx-2 text-sm text-white transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Blog personal">
                            Mi blog personal
                        </a>

                        <a href="https://github.com/hectorgarciatw" target="_blank" className="mx-2 text-sm text-white transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="GitHub">
                            Visita mi GitHub
                        </a>

                        <a href="#" target="_blank" className="mx-2 text-sm text-white transition-colors duration-300 hover:text-gray-500 dark:hover:text-gray-300" aria-label="Contacto">
                            Contacto
                        </a>
                    </div>
                </div>
