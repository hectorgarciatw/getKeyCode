                ...
                <div className="mx-auto rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
                    ...
                    <ul className="mt-6 space-y-2">
                        <li className="flex items-center gap-1">
                            ...
                            {filteredKey ? (
                                <>
                                    <span className="text-white block">{`Key pressed: ${filteredKey.key}`}</span>
                                    <br />
                                    <span className="text-white block">{`Code: ${filteredKey.code}`}</span>
                                </>
                            ) : (
                                <span className="text-white">KeyCode not found</span>
                            )}
                        </li>
                    </ul>
